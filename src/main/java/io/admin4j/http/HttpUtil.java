...
public class HttpUtil {
    ...
    public static io.admin4j.http.HttpRequestBuilder postBuilder(String url) {
        return new io.admin4j.http.HttpRequestBuilder(url, Method.POST);
    }

    public static io.admin4j.http.HttpRequestBuilder getBuilder(String url) {
        return new io.admin4j.http.HttpRequestBuilder(url, Method.GET);
    }
