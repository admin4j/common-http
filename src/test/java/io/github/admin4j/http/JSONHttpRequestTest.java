 ...
 */
class JSONHttpRequestTest {
    JSONHttpRequest httpRequest;

    @BeforeEach
    void init() {
        HttpConfig httpConfig = new HttpConfig();
        httpRequest = new JSONHttpRequest(httpConfig);
    }

    @Test
    void getStr() throws IOException {
        String s = HttpUtil.getStr("https://www.hutool.cn/docs/#/http/Http%E8%AF%B7%E6%B1%82-HttpRequest", Pair.of("id", "介绍"));
    ...
    void get() throws IOException {
        ...
        JSONObject object = HttpUtil.get("http://192.168.1.13:9100/system/dict/i18n",
                Pair.of("id", "介绍"),
    ...
    @Test
    void post() {
        JSONObject post = HttpUtil.post("https://oapi.dingtalk.com/robot/send?access_token=37f5954ab60ea8b2e431ae9101b1289c138e85aa6eb6e3940c35ee13ff8b6335",
    ...
    void postForm() {
        ...
        JSONObject object = HttpUtil.postForm("http://192.168.1.13:9100/auth/login",
                formParams
        );
    ...
    void upload() throws IOException {
        ...
        JSONObject xx = HttpUtil.upload("https://upload.qiniup.com/", formParams);
